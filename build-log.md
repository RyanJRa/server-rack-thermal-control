25 June 2026 - Intake decisions: both Pi(s) and resistor load bank (bank as repeatable thermal source fo clean KPIs); custom sense board; DS18B20 chosen over DHT11 for control path (accuracy + speed); load bank needs power resistors sice 1/4 W kit parts can't dissipate real heat. ACS712 linear Hall Sensor VIOUT(Q) is VCC x 0.5 and VCC is 5V. VIOUT = 2.5V
VIOUT = 2.5V
Sensitivity = 0.185 V/amp
ESP32 ceiling = 3.3V; Amps for 5A rated ACS712 to reach ESP32 ceiling: (3.3 - 2.5) / 0.185 = 4.32A
Conclsuion: raw wiring risks over-voltage damage to the ESP32 above 4.3A. Sensor idles at 2.5V, bidirectional swing.
